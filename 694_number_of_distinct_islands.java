class Solution {
    ...
    // visit island by storing direction ex. 1, 2, 1, 3
    // and use set to handle duplication
    // at beginning, add 0 to list; when finish, also add 0
    // in that way, we can make sure unique island
...
//     // Space Complexity: O(length * width) (because keep all elements)
//     public int numDistinctIslands(int[][] grid) {
